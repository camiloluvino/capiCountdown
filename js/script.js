...
// --- TALLY COUNTDOWN (Restored) ---
// Bamboo stick bundles (groups of 5) + Tree Countdown

function renderTally(days, animateRemoval = false) {
    // Also update Tree Countdown
    if (window.renderTree) {
        window.renderTree(days);
    }

    // Render bamboo tally bundles
    ...
    if (animateRemoval) {
        ...
        fallingStick.style.height = '60px';
